...
## Completeions
##
[ -d "$NIX_PROFILE_DEFAULT" ] && fpath+=$NIX_PROFILE_DEFAULT/share/zsh/site-functions
...
_completions dlv completion
_completions dprint completions
_completions fzf '' --
_completions golangci-lint completion
